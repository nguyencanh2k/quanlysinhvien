...
!(function () {
    ...
    var e = window.document,
        ...
        w = function (e, o, t) {
            var r = function () {
                return m(e, o, r), t.apply(this, arguments);
            };
            v(e, o, r);
        },
        k = function (e, o, t) {
            if (null != e.readyState) {
                var r = 'readystatechange',
                    a = function () {
                        if (o.test(e.readyState)) return m(e, r, a), t.apply(this, arguments);
                    };
                v(e, r, a);
            }
        },
        ...
        z = function (e, o) {
            return '@media(prefers-color-scheme:' + e + '){' + x[g(x, o) ? o : e] + '}';
        },
        y = {
            'comment-discussion': {
                heights: {
        ...
        C = function (e, o) {
            (e = b(e).replace(/^octicon-/, '')), g(y, e) || (e = 'mark-github');
        ...
        F = function (e, o, t) {
            var r = u(e.ownerDocument),
                ...
                n =
                    ...
                    (function (e) {
                        ...
                        return (
                            x[g(x, o['no-preference']) ? o['no-preference'] : 'light'] +
                            z('light', o.light) +
                            z('dark', o.dark)
                        );
                    })(o['data-color-scheme']);
            ...
            var i = 'large' === b(o['data-size']),
                ...
                d = e.appendChild(r('div', { className: 'widget' + (i ? ' widget-lg' : '') }, [c])),
                s = c.hostname.replace(/\.$/, '');
            if (('.' + s).substring(s.length - l.length) !== '.' + l) return c.removeAttribute('href'), void t(d);
            var f = (' /' + c.pathname).split(/\/+/);
            if (
                ((((s === l || s === 'gist.' + l) && 'archive' === f[3]) ||
                    (s === l &&
                        'releases' === f[3] &&
                        ('download' === f[4] || ('latest' === f[4] && 'download' === f[5]))) ||
                    s === 'codeload.' + l) &&
                    (c.target = '_top'),
                ...
                var h, v;
                if (!f[2] && f[1]) (v = 'followers'), (h = '?tab=followers');
                else if (!f[3] && f[2]) (v = 'stargazers_count'), (h = '/stargazers');
                else if (f[4] || 'subscription' !== f[3])
                    if (f[4] || 'fork' !== f[3]) {
                        if ('issues' !== f[3]) return void t(d);
                        (v = 'open_issues_count'), (h = '/issues');
                    } else (v = 'forks_count'), (h = '/network/members');
                else (v = 'subscribers_count'), (h = '/watchers');
                var m = f[2] ? '/repos/' + f[1] + '/' + f[2] : '/users/' + f[1];
                A.call(this, 'https://api.github.com' + m, function (e, o) {
                    if (!e) {
                        var a = o[v];
                        d.appendChild(
                            r(
                ...
                if (
                    (o.getAttribute &&
                        (o = (function (e) {
                            ...
                            return (
                                s(['icon', 'color-scheme', 'text', 'size', 'show-count'], function (t) {
                                    var r = 'data-' + t;
                    ...
                    var a = f('span');
                    F(a.attachShadow({ mode: 'closed' }), o, function () {
                        r(a);
                    });
                } else {
                    var n = f('iframe', {
                    ...
                    v(n, 'load', l), e.body.appendChild(n);
                }
        };
    o.protocol + '//' + o.host + o.pathname === i
        ? F(e.body, p(window.name || o.hash.replace(/^#/, '')), function () {})
        : (function (o) {
              ...
              var o,
                  t = e.querySelectorAll
                      ...
                      : ((o = []),
                        s(e.getElementsByTagName('a'), function (e) {
                            -1 !== (' ' + e.className + ' ').replace(/[ \t\n\f\r]+/g, ' ').indexOf(' github-button ') &&
                                o.push(e);
                        }),
                        o);
              s(t, function (e) {
